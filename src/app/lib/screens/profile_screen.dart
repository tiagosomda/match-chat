...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget _settingsButton(AppColors c) {
    return Tooltip(
  ...
  /// A card entry point to the (now separate) Settings screen, so the relocated
  /// appearance/language/content/about options stay discoverable from Profile.
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(Icons.settings_outlined, size: 19, color: c.text),
          ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  context.l10n.t('settingsCardSub'),
