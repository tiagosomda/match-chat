...
class SeedService {
  ...
  Future<void> seed() async {
    ...
    final samples = <Map<String, dynamic>>[
      _m('Brazil', 'Argentina', 'Quarter-Final', MatchStatus.finished,
          DateTime.utc(2026, 6, 24, 23, 0),
          a: 2, b: 1),
      _m('Portugal', 'Morocco', 'Round of 16', MatchStatus.finished,
          DateTime.utc(2026, 6, 23, 18, 0),
          a: 1, b: 0),
      _m('France', 'Germany', 'Group Stage · Group C', MatchStatus.finished,
          DateTime.utc(2026, 6, 25, 18, 0),
          a: 3, b: 3),
      _m('Belgium', 'USA', 'Group Stage · Group B', MatchStatus.live,
          DateTime.utc(2026, 6, 25, 23, 0),
          a: 1, b: 1),
      _m('Spain', 'Japan', 'Group Stage · Group E', MatchStatus.upcoming,
          DateTime.utc(2026, 6, 26, 1, 0)),
      _m('Netherlands', 'Croatia', 'Group Stage · Group F',
          MatchStatus.upcoming, DateTime.utc(2026, 6, 28, 19, 0)),
    ];
