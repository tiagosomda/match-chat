...
const Map<String, String> _en = {
  ...
  'statusLive': '● LIVE',
  'statusLiveSoon': 'LIVE SOON',
  'statusJustFinished': 'JUST FINISHED',
  'statusToday': 'TODAY',
  'statusTomorrow': 'TOMORROW',
  'statusFullTime': 'FULL TIME',
  'statusPenaltiesLive': 'PENALTIES · LIVE',
  'statusFullTimePens': 'FULL TIME · PENS',
  'statusPensShort': 'PENS',
  'viewList': 'Schedule',
  'viewBracket': 'Bracket',
  'bracketThirdPlace': 'THIRD PLACE',
  'bracketTbd': 'TBD',
  'bracketWinnerHidden': 'Winner hidden',
  'bracketRevealWinner': 'Reveal winner',
  'bracketHint': 'Drag to pan · pinch to zoom',
  'bracketEmptyTitle': 'No knockout stage yet',
  'bracketEmptyBody': 'It appears here once the Round of 32 is drawn.',
  'zoomIn': 'Zoom in',
  'zoomOut': 'Zoom out',
  ...
  'tapForFirstKick': 'Tap to reveal the first kick',
  'scoredUpper': 'SCORED',
  'missedUpper': 'MISSED',
  'waitingForKicks': 'Waiting for shootout details…',
  'predictions': 'Predictions',
  'comments': 'Chat',
  'goalsCount': '{n} GOALS',
  'revealGoals': 'Reveal goal times',
  'noGoalsYet': 'No goals yet',
  'goalsStage1': '1/3 · Goal details hidden',
  ...
  'buzzNewSince': 'NEW SINCE YOUR LAST VISIT',
  'buzzJumpLatest': 'Latest',
  'buzzReplyToYou': 'REPLIED TO YOU',
  ...
  'coffeePromptBody':
      'I made Match Chat for free, with no ads or subscriptions. If you’re '
      'enjoying it, you can help cover the running costs by buying me a coffee.',
  'coffeeMaybeLater': 'Maybe later',
  'coffeeNope': 'Nooope!',
...
const Map<String, String> _es = {
  ...
  'statusLive': '● EN VIVO',
  'statusLiveSoon': 'POR EMPEZAR',
  'statusJustFinished': 'RECIÉN FINALIZADO',
  'statusToday': 'HOY',
  'statusTomorrow': 'MAÑANA',
  'statusFullTime': 'FINAL',
  'statusPenaltiesLive': 'PENALES · EN VIVO',
  'statusFullTimePens': 'FINAL · PENALES',
  'statusPensShort': 'PENALES',
  'viewList': 'Calendario',
  'viewBracket': 'Cuadro',
  'bracketThirdPlace': 'TERCER PUESTO',
  'bracketTbd': 'POR DEFINIR',
  'bracketWinnerHidden': 'Ganador oculto',
  'bracketRevealWinner': 'Mostrar ganador',
  'bracketHint': 'Arrastra para mover · pellizca para zoom',
  'bracketEmptyTitle': 'Aún no hay eliminatorias',
  'bracketEmptyBody': 'Aparecen cuando se define la ronda de 32.',
  'zoomIn': 'Acercar',
  'zoomOut': 'Alejar',
  ...
  'roundOf16': 'Octavos',
  'roundQuarter': 'Cuartos de final',
  'roundSemi': 'Semifinales',
  'roundFinal': 'Final',
  'roundN': 'Ronda {n}',
  ...
  'tapForFirstKick': 'Toca para mostrar el primer penal',
  'scoredUpper': 'GOL',
  'missedUpper': 'FALLÓ',
  'waitingForKicks': 'Esperando los detalles de la tanda…',
  'predictions': 'Pronósticos',
  'comments': 'Chat',
  'goalsCount': '{n} GOLES',
  'revealGoals': 'Mostrar minutos de gol',
  ...
  'coffeePromptBody':
      'Hice Match Chat gratis, sin anuncios ni suscripciones. Si te está '
      'gustando, puedes ayudarme a cubrir los gastos invitándome a un café.',
  'coffeeMaybeLater': 'Quizá más tarde',
...
const Map<String, String> _pt = {
  ...
  'statusLive': '● AO VIVO',
  'statusLiveSoon': 'A COMEÇAR',
  'statusJustFinished': 'TERMINOU AGORA',
  'statusToday': 'HOJE',
  'statusTomorrow': 'AMANHÃ',
  'statusFullTime': 'FIM DE JOGO',
  'statusPenaltiesLive': 'PENÁLTIS · AO VIVO',
  'statusFullTimePens': 'FIM · PENÁLTIS',
  'statusPensShort': 'PENÁLTIS',
  'viewList': 'Calendário',
  'viewBracket': 'Quadro',
  'bracketThirdPlace': 'TERCEIRO LUGAR',
  'bracketTbd': 'A DEFINIR',
  'bracketWinnerHidden': 'Vencedor oculto',
  'bracketRevealWinner': 'Revelar vencedor',
  'bracketHint': 'Arrasta para mover · aperta para zoom',
  'bracketEmptyTitle': 'Ainda não há eliminatórias',
  'bracketEmptyBody': 'Aparecem quando a fase a eliminar começar.',
  'zoomIn': 'Ampliar',
  'zoomOut': 'Reduzir',
  'zoomFit': 'Ajustar ao ecrã',
  'openMatch': 'Abrir jogo',
  'roundOf64': 'Trigésimos de final',
  'roundOf32': 'Dezasseis-avos',
  'roundOf16': 'Oitavos de final',
  'roundQuarter': 'Quartos de final',
  'roundSemi': 'Meias-finais',
  'roundFinal': 'Final',
  'roundN': 'Ronda {n}',
  ...
  'tapForFirstKick': 'Toca para revelar o primeiro penálti',
  'scoredUpper': 'MARCOU',
  'missedUpper': 'FALHOU',
  'waitingForKicks': 'À espera dos detalhes dos penáltis…',
  'predictions': 'Palpites',
  'comments': 'Chat',
  'goalsCount': '{n} GOLOS',
  'revealGoals': 'Revelar minutos dos golos',
  ...
  'buzzNewSince': 'NOVO DESDE A TUA ÚLTIMA VISITA',
  'buzzJumpLatest': 'Recentes',
  ...
  'coffeePromptBody':
      'Fiz o Match Chat gratuitamente, sem anúncios nem subscrições. Se estás '
      'a gostar, podes ajudar a cobrir os custos pagando-me um café.',
  'coffeeMaybeLater': 'Talvez mais tarde',
...
const Map<String, String> _ptBR = {
  ...
  'buzzNewSince': 'NOVO DESDE SUA ÚLTIMA VISITA',
  'buzzReplyToYou': 'RESPONDEU VOCÊ',
  'signIn': 'Entrar',
  'signOut': 'Sair',
  'save': 'Salvar',
  'password': 'Senha',
  ...
  'statusLiveSoon': 'COMEÇANDO',
  'statusJustFinished': 'RECÉM-ENCERRADO',
  'matchNotFound': 'Partida não encontrada.',
  'yourLocalTime': 'SEU HORÁRIO LOCAL ({tz})',
  'revealScore': 'Revelar placar',
  'goalsCount': '{n} GOLS',
  'revealGoals': 'Revelar minutos dos gols',
  ...
  'contentPrefsHint': 'Esconda os recursos que você não usa.',
  'yourPickUpper': 'SEU PALPITE',
  ...
  'coffeePromptBody':
      'Criei o Match Chat de graça, sem anúncios nem assinaturas. Se você está '
      'curtindo, pode ajudar a cobrir os custos me pagando um café.',
  ...
  'bracketThirdPlace': 'TERCEIRO LUGAR',
  'bracketTbd': 'A DEFINIR',
  'bracketHint': 'Arraste para mover · pince para zoom',
  'bracketEmptyTitle': 'Ainda não há mata-mata',
  'bracketEmptyBody': 'Aparece quando o mata-mata começar.',
  'zoomIn': 'Aproximar',
  'zoomOut': 'Afastar',
