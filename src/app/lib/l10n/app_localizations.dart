...
const Map<String, String> _en = {
  ...
  'bracketEmptyTitle': 'No bracket yet',
  'bracketEmptyBody': 'The bracket appears once the knockout stage is set.',
  'zoomIn': 'Zoom in',
  'zoomOut': 'Zoom out',
...
const Map<String, String> _es = {
  ...
  'bracketEmptyTitle': 'Aún no hay llave',
  'bracketEmptyBody': 'La llave aparece cuando se define la fase eliminatoria.',
  'zoomIn': 'Acercar',
  'zoomOut': 'Alejar',
...
const Map<String, String> _pt = {
  ...
  'bracketEmptyTitle': 'Ainda não há quadro',
  'bracketEmptyBody': 'O quadro aparece quando a fase a eliminar estiver definida.',
  'zoomIn': 'Ampliar',
  'zoomOut': 'Reduzir',
...
const Map<String, String> _ptBR = {
  ...
  'bracketEmptyTitle': 'Ainda não há chave',
  'bracketEmptyBody': 'A chave aparece quando a fase eliminatória é definida.',
  'zoomIn': 'Aproximar',
  'zoomOut': 'Afastar',
